      ...
      <div className="container mx-auto px-4 py-6 space-y-4">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              {log.quantity !== undefined && (
                <div>
                  <p className="text-sm text-muted-foreground">{t("fields.quantity")}</p>
        ...
        <Tabs defaultValue="notes">
          <TabsList className="grid w-full grid-cols-2">
            <TabsTrigger value="notes">{t("fields.notes")}</TabsTrigger>
            <TabsTrigger value="info">{tCommon("info")}</TabsTrigger>
          </TabsList>
        ...
        <Dialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                {tCommon("deleteDialog.description", { title: log.title })}
              </DialogDescription>
            </DialogHeader>
            <DialogFooter>
