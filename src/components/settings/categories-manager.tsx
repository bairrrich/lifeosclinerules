...
import { Tag, Plus, Save, Edit2, Trash2 } from "lucide-react"
                    ...
                    <div className="space-y-3">
                      <div className="grid grid-cols-2 gap-2">
                        ...
                        <select
                          ...
                          onChange={(e) => setEditingCategory({ ...editingCategory, type: e.target.value as LogType })}
                        >
        ...
        <div className="p-3 rounded-xl border-2 border-dashed space-y-3">
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <select
              ...
              onChange={(e) => setNewCategory({ ...newCategory, type: e.target.value as LogType })}
            >
              {Object.entries(logTypeLabels).map(([type, { label }]) => (
                <option key={type} value={type}>{label}</option>
              ))}
