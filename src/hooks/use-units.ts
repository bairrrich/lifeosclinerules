...
export function useUnits() {
  ...
  const getUnitsByType = useCallback((type: Unit["type"]) => {
    return units.filter(u => u.type === type)
  }, [units])

  // Получить сокращение по id
  const getAbbreviation = useCallback((id: string) => {
...
export const defaultUnits: Unit[] = [
  ...
  { id: "kg", name: "килограмм", abbreviation: "кг", type: "weight", created_at: "", updated_at: "" },
  { id: "mg", name: "миллиграмм", abbreviation: "мг", type: "weight", created_at: "", updated_at: "" },
  
  // Объём
  { id: "ml", name: "миллилитр", abbreviation: "мл", type: "volume", created_at: "", updated_at: "" },
  { id: "l", name: "литр", abbreviation: "л", type: "volume", created_at: "", updated_at: "" },
  { id: "tsp", name: "чайная ложка", abbreviation: "ч.л.", type: "volume", created_at: "", updated_at: "" },
  { id: "tbsp", name: "столовая ложка", abbreviation: "ст.л.", type: "volume", created_at: "", updated_at: "" },
  { id: "cup", name: "стакан", abbreviation: "стакан", type: "volume", created_at: "", updated_at: "" },
  { id: "oz", name: "унция", abbreviation: "oz", type: "volume", created_at: "", updated_at: "" },
  { id: "drop", name: "капля", abbreviation: "капля", type: "volume", created_at: "", updated_at: "" },
  ...
  { id: "clove", name: "зубчик", abbreviation: "зубч.", type: "count", created_at: "", updated_at: "" },
  { id: "pinch", name: "щепотка", abbreviation: "щепотка", type: "count", created_at: "", updated_at: "" },
  { id: "taste", name: "по вкусу", abbreviation: "по вкусу", type: "count", created_at: "", updated_at: "" },
